const css = `.hero{display:grid;grid-template-columns:1fr;gap:44px;align-items:center;max-width:1120px;margin:0 auto;padding:60px 26px 40px}.hero-copy{text-align:center}.hero-art{position:relative;justify-self:center;width:100%;max-width:440px}.hero-art::before{content:'';position:absolute;inset:18px -18px -18px 18px;background:var(--champagne);z-index:0}.hero-art img{position:relative;z-index:1;display:block;width:100%;height:auto;border:1px solid var(--line)}@media(min-width:900px){.hero{grid-template-columns:1.05fr 1fr;gap:70px;padding:90px 40px 64px}.hero-copy{text-align:left}.hero-copy .hint{text-align:left;margin-left:0}}`;
